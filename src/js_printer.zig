            ...
            switch (stmt.data) {
                ...
                .s_import => |s| {
                    ...
                    if (comptime is_bun_platform) if (record.loader) |loader| switch (loader) {
                        ...
                        .csv => p.printWhitespacer(ws(" with { type: \"csv\" }")),
                        .csv_no_header => p.printWhitespacer(ws(" with { type: \"csv_no_header\" }")),
                        .tsv => p.printWhitespacer(ws(" with { type: \"tsv\" }")),
                        .tsv_no_header => p.printWhitespacer(ws(" with { type: \"tsv_no_header\" }")),
